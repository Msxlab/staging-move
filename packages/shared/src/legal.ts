  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Public-data lookups and AI features. When you save an address, LocateFlow may send only that location's coordinates or area identifiers — or, for vehicle lookups, only the VIN you enter — to public and government data services such as FEMA, EPA, NCES, NWS, FCC, DOE/OpenEI, HUD, NLR/AFDC, and NHTSA to retrieve informational context like flood zone, hazard index, school district, broadband availability, air quality, water system, electric utility, housing-market context, nearby EV charging, weather, and recall data. LocateFlow-briefing text may be generated by a third-party AI provider using only coarse, de-identified signals. Your name, email, and account data are never sent to those services. These outputs are informational only, are not professional advice, and are not insurance, lending, legal, or safety determinations; their accuracy follows the public sources. The Privacy Policy describes these data flows in detail.",
