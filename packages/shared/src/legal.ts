  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Mover directory. LocateFlow may display a directory of household-goods movers built from public FMCSA (Federal Motor Carrier Safety Administration) registration data, including USDOT numbers and related safety information. This data is shown for verification convenience only. A listing is not an endorsement, recommendation, ranking guarantee, or statement about a mover's quality, and accuracy and currency follow the federal source, which may lag real-world changes. Verify any mover directly through FMCSA's official tools before hiring.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Public-data lookups and AI features. When you save an address, LocateFlow may send only that location's coordinates or area identifiers — or, for vehicle lookups, only the VIN you enter — to public and government data services such as FEMA, EPA, NCES, NWS, FCC, DOE/OpenEI, and NHTSA to retrieve informational context like flood zone, hazard index, school district, broadband availability, air quality, water system, electric utility, weather, and recall data. Move-briefing text may be generated by a third-party AI provider using only coarse, de-identified signals. Your name, email, and account data are never sent to those services. These outputs are informational only, are not professional advice, and are not insurance, lending, legal, or safety determinations; their accuracy follows the public sources. The Privacy Policy describes these data flows in detail.",
