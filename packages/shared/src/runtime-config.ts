...
export const RUNTIME_CONFIG_DEFINITIONS: readonly RuntimeConfigDefinition[] = [
  ...
  },
  {
    ...
    label: "Stripe Price ID — Individual",
    description: "Stripe recurring price identifier for the Individual web plan.",
    scope: "WEB",
    category: "BILLING",
    isSecret: false,
    requiredInProduction: true,
  ...
  },
  {
    ...
    description: "Cloudinary API key for media operations.",
    scope: "WEB",
    category: "STORAGE",
    isSecret: false,
    requiredInProduction: true,
  ...
  },
  {
    ...
    description: "Cloudinary API secret for signed media operations.",
    scope: "WEB",
    category: "STORAGE",
    isSecret: true,
    requiredInProduction: true,
