  ...
  return (
    ...
    >
      <div className="rounded-2xl border bg-muted/30 p-5 text-sm leading-6 text-muted-foreground">
        ...
        <p>
          DPA contact:{" "}
          <a href={mailto(LEGAL_CONTACTS.dpa, "Move DPA inquiry")} className="underline">
            {LEGAL_CONTACTS.dpa}
          </a>
        </p>
      </div>
      ...
      <PublicSection title="4. Subprocessors">
        ...
        <p>
          A production subprocessor list with legal names, locations, and processing purposes must be finalized before full business launch. Subprocessor questions can be sent to <a href={mailto(LEGAL_CONTACTS.dpa, "Move subprocessor inquiry")} className="underline">{LEGAL_CONTACTS.dpa}</a>.
        </p>
      </PublicSection>
