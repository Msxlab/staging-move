...
export const viewport: Viewport = {
  ...
  // sourced from the canonical dark token and the clean light app canvas.
  ...
  return (
    ...
    >
      <head>
         ...
         * tracks the active theme. Light value mirrors the clean app canvas;
         * dark keeps the existing brand deep-navy. A bare fallback follows for
         * UAs that ignore `media`.
         */}
