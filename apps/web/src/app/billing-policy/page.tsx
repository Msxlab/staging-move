  ...
  return (
    ...
    >
      ...
      <PublicSection title="Billing questions">
        <p>
          For billing support, email <a href={mailto(LEGAL_CONTACTS.billing, "LocateFlow billing request")} className="underline">{LEGAL_CONTACTS.billing}</a>. See the <Link href="/refund" className="underline">Refund Policy</Link> for refund request windows and exclusions.
        </p>
      </PublicSection>
    </PublicPageShell>
  );
