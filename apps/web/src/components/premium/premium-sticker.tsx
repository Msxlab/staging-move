...
function MedalFamily({ size = 80 }: SizeProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 80 80">
      ...
      <circle cx="40" cy="18" r="1.8" fill="#CBA45E" />
    </svg>
  );
}
...
function MinimalIndividual({ size = 80 }: SizeProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80">
      <circle cx="40" cy="40" r="30" fill="none" stroke="#CBA45E" strokeWidth="1.5" />
      <text
        x="40"
        y="46"
        textAnchor="middle"
    ...
    <svg width={size} height={size} viewBox="0 0 80 80" className="ps-pro">
      <defs>
        <linearGradient id={`mnp-${id}`} x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#DDE7F5" />
          <stop offset="50%" stopColor="#CBA45E" />
          <stop offset="100%" stopColor="#B0852F" />
        </linearGradient>
      </defs>
      <circle
    ...
    <svg width={size} height={size} viewBox="0 0 80 80" className="ps-pro">
      <defs>
        ...
        <radialGradient id={`sp-glow-${id}`}>
          <stop offset="0%" stopColor="#CBA45E" stopOpacity="0.4" />
          <stop offset="100%" stopColor="#CBA45E" stopOpacity="0" />
        </radialGradient>
      </defs>
      ...
      <line x1="20" y1="50" x2="60" y2="50" stroke="#CBA45E" strokeOpacity="0.3" strokeWidth="0.3" />
      <text
        x="40"
        y="58"
        textAnchor="middle"
