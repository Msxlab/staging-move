  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open ? (
        <div
          role="menu"
          className="fixed inset-x-2 bottom-[calc(96px+env(safe-area-inset-bottom))] z-[60] max-h-[70vh] overflow-y-auto rounded-lg border border-border bg-card shadow-lg sm:absolute sm:inset-x-auto sm:bottom-auto sm:right-0 sm:top-full sm:z-20 sm:mt-1 sm:max-h-none sm:w-64"
        >
