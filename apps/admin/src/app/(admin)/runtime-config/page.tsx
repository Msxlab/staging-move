  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <MetricCard label="Configured" value={configs.filter((item) => item.configured).length} />
        <MetricCard label="DB Overrides" value={configs.filter((item) => item.source === "DB").length} />
                      ...
                      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        <div className="space-y-2">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <StatusBadge label={item.source} tone={item.source === "MISSING" ? "danger" : item.source === "DB" ? "success" : "neutral"} />
