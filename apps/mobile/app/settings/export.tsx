...
const styles = StyleSheet.create({
  ...
  noticeBox: { marginBottom: 16, padding: 14, borderRadius: theme.radius.lg, backgroundColor: "rgba(227, 176, 75,0.08)", borderWidth: 1, borderColor: "rgba(227, 176, 75,0.2)" },
  ...
  cardIconBox: { width: 40, height: 40, borderRadius: 12, backgroundColor: theme.colors.primaryFaded, borderWidth: 1, borderColor: "rgba(212, 132, 106,0.2)", alignItems: "center", justifyContent: "center" },
  ...
  formatBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, paddingVertical: 10, borderRadius: 12, backgroundColor: theme.colors.primaryFaded, borderWidth: 1, borderColor: "rgba(212, 132, 106,0.2)" },
