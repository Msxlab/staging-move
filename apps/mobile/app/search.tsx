...
export default function SearchScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <HeroCard style={styles.hero} radius={theme.radius["2xl"]} padding={16}>
      ...
      <View style={styles.searchRow}>
        <View style={styles.searchBox}>
          <SearchIcon size={16} color={theme.colors.dim} />
          <TextInput
            ref={inputRef}
      ...
      {loading ? (
        ...
        <SectionList
          ...
          renderSectionHeader={({ section }) => {
            const sec = section as SearchSection;
            const Icon = sec.icon;
            return (
              <View style={styles.sectionHeader}>
                <Icon size={13} color={theme.colors.faint} />
...
const makeStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    heroKicker: { fontSize: 10, fontFamily: fonts.sansBold, letterSpacing: 1.4, textTransform: "uppercase", color: theme.colors.faint },
    heroTitle: { marginTop: 3, fontSize: 18, fontFamily: fonts.serifBold, color: theme.colors.text },
    heroSub: { marginTop: 4, fontSize: 12, lineHeight: 17, fontFamily: fonts.sans, color: theme.colors.dim },
    ...
    domainValue: { fontSize: 13, fontFamily: fonts.monoMedium, color: theme.colors.text, fontVariant: ["tabular-nums"] },
    domainLabel: { maxWidth: "100%", fontSize: 9.5, fontFamily: fonts.sans, color: theme.colors.faint },
    ...
    resultTitle: { fontSize: 13.5, fontFamily: fonts.sansSemibold, color: theme.colors.text },
    resultSubtitle: { fontSize: 11, fontFamily: fonts.sans, color: theme.colors.faint, marginTop: 2 },
  });
